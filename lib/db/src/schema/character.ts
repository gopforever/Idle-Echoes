...
export const charactersTable = pgTable("characters", {
  ...
  humanoidKills: integer("humanoid_kills").notNull().default(0),
  beastKills: integer("beast_kills").notNull().default(0),
  elementalKills: integer("elemental_kills").notNull().default(0),
  constructKills: integer("construct_kills").notNull().default(0),
  planarKills: integer("planar_kills").notNull().default(0),
  faeKills: integer("fae_kills").notNull().default(0),
  gnollKills: integer("gnoll_kills").notNull().default(0),
  goblinKills: integer("goblin_kills").notNull().default(0),
  orcKills: integer("orc_kills").notNull().default(0),
  giantKills: integer("giant_kills").notNull().default(0),
